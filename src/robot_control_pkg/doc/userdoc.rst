...
1. To check that *diffbot* description is working properly use following launch commands
   ...
   .. code-block:: shell
    ...
    ros2 launch robot_control_pkg view_robot.launch.py
...
4. Check if controllers are running
   ...
   .. code-block:: shell
    ...
    diff_controller[diff_drive_controller/DiffDriveController] active
...
5. If everything is fine, now you can send a command to *Diff Drive Controller* using ROS 2 CLI interface:
   ...
   .. code-block:: shell
    ...
    ros2 topic pub --rate 30 /diff_controller/cmd_vel_unstamped geometry_msgs/msg/Twist "linear:
      x: 0.7
      y: 0.0
      z: 0.0
    angular:
   ...
   .. code-block:: shell
    ...
    [RobotControlHardware]: Got command 43.33333 for 'left_wheel_joint'!
    [RobotControlHardware]: Got command 50.00000 for 'right_wheel_joint'!
